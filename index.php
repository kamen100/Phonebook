...
<body>
	...
	<div class="container">
        ...
        <h2 class="form-signin-heading">Телефонен указател</h2><hr />
        <button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span> &nbsp; Добави запис</button>
        ...
        $stmt = $db_con->prepare("SELECT * FROM tbl_phonebook ORDER BY emp_id DESC");
        $stmt->execute();
